...
class BrowserbaseCore(abc.ABC, Generic[ST, AT]):
    ...
    #     )
    #
    #     new_session = self._sync_session_class(self, session_options=options)
    #     new_session.start()
    #     try:
    #         yield new_session
    #     finally:
    #         # If we the session has not already ended implicitly,
    #         # end the session.
    #         if not new_session.implicit_end:
    #             new_session.end()
    ...
    #     )
    #
    #     new_session = self._async_session_class(self, session_options=options)
